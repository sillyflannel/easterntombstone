...
(defproject digitalbird.sillyflannel.easterntombstone/lein-template "0.1.0-SNAPSHOT" :description "A template for easterntombstone library projects." :url "https://github.com/sillyflannel/easterntombstone" :license {:name "GNU GPL3" :url "http://www.gnu.org/licenses/gpl.txt"} :eval-in-leiningen true)
